...
from pulser_diff.pulser.json.supported import validate_serialization
...
class PulserDecoder(JSONDecoder):
    ...
    def object_hook(self, obj: dict[str, Any]) -> Any:
        ...
        if (
            obj_name == "Variable"
            and module_str == "pulser_diff.pulser.parametrized.variable"
        ):
            var_name = obj["name"]
            try:
        ...
        if "Device" in obj_name:
            ...
            if _channels and not (channel_ids or channel_objs):
                ...
                obj["__kwargs__"]["channel_objects"] = tuple(_channels_dict.values())

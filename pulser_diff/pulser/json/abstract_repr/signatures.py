...
if TYPE_CHECKING:
    from pulser_diff.pulser.parametrized.variable import Variable, VariableItem
...
SIGNATURES: dict[str, PulserSignature] = {
    ...
    "CustomWaveform": PulserSignature(pos=("samples",), extra=dict(kind="custom")),
    ...
    "truediv": PulserSignature(pos=("lhs", "rhs"), extra=dict(expression="div")),

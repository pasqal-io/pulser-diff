...
from pulser_diff.pulser.devices._device_datacls import Device, VirtualDevice
from pulser_diff.pulser.devices._devices import (
    AnalogDevice,
    Chadoq2,
    DigitalAnalogDevice,
    IroiseMVP,
)
from pulser_diff.pulser.devices._mock_device import MockDevice

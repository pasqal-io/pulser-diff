...
from pulser_diff.pulser.register._coordinates import COORD_PRECISION, CoordsCollection
...
class Traps(ABC, CoordsCollection):
    ...
    def get_traps_from_coordinates(self, *coordinates: ArrayLike) -> list[int]:
        ...
        """
        traps = []
        rounded_coords = np.round(np.array(coordinates), decimals=COORD_PRECISION)

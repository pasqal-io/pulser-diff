...
def _fix_border_vals(deriv: Tensor, border_indices: list, dt) -> Tensor:
    prev_idx = 0
    with torch.no_grad():
...
def deriv_time(
    ...
    Args:
        ...
        pulse_endtimes (list | None, optional): collection of times denoting start/end of pulses in sequence. 
        Defaults to None.
...
def deriv_param(
    ...
    if times is None:
        ...
        t = times[-1] if t is None else t / 1000
